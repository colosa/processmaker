    ...
    public function execute ()
    {
        ...
        if ($iOcurrences) {
            for ($i = 0; $i < $iOcurrences; $i ++) {
                ...
                if ($i < $iOcurrences - 1 && $count_equal === 0) {
                    $sw_evaluate2 = true;
                    $iii = $aMatch[0][$i][1] + strlen($aMatch[0][$i][0]);
                    $sss = substr($this->sScript, $iii, $aMatch[0][$i + 1][1] - $iii);
                    if (strpos($sss, '=') !== false && strpos($sss, '==') === false && strpos($sss, '===') === false && strpos($sss, '!=') === false && strpos($sss, '!==') === false && strpos($sss, '<=') === false && strpos($sss, '>=') === false) {
                        $sw_evaluate2 = false;
                    }
                }
                /** patch1 end */
                ...
                switch ($aMatch[1][$i][0]) {
                    case '@':
                        if ($bEqual && $sw_evaluate || $sw_evaluate2) {
                            if (! isset( $aMatch[5][$i][0] )) {
