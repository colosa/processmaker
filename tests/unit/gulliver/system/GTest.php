...
class GTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testArray_fill_value()
    {
        ...
        $arrayCorrect = array('', '', '', '');
        $arrayRes = G::array_fill_value($arrayTest);
        $this->assertEquals($arrayCorrect, $arrayRes);

        // $recursive = false and new Value = 'valueTest'
        $arrayTest = array('value1','value2','value3','value4');
        $arrayCorrect = array('valueTest', 'valueTest', 'valueTest', 'valueTest');
    ...
    public function testArray_concat()
    {
        ...
        $this->assertEquals($arrayResponse, $arrayCorrect);
    }
    ...
    public function testGetMacAddress()
    {
        ...
        $this->assertEquals(count($element), 6);
        $this->assertEquals(strlen($element['0']), 2);
        $this->assertEquals(strlen($element['1']), 2);
        $this->assertEquals(strlen($element['2']), 2);
        $this->assertEquals(strlen($element['3']), 2);
        $this->assertEquals(strlen($element['4']), 2);
        $this->assertEquals(strlen($element['5']), 2);
    }
    ...
    public function testMicrotime_float()
    {
        ...
        $this->assertTrue(is_real($response));
    }
    ...
    public function testLookup()
    {
        ...
        //$this->assertEquals($response,$ip);
        /*
         * @error_function
         * function no return the ip
         */
