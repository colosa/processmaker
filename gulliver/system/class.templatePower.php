...
class TemplatePowerParser
{
    public $tpl_base; //Array( [filename/publiccontent], [T_BYFILE/T_BYpublic] )
    public $tpl_include; //Array( [filename/publiccontent], [T_BYFILE/T_BYpublic] )
    public $tpl_count;
    public $parent = Array (); // $parent[{blockname}] = {parentblockname}
     ...
     *
     * @return void
                                //check if defined as constant in templa
     * @access public
     */
...
{
    public $index = Array (); // $index[{blockname}]  = {indexnumber}
    public $content = Array ();
    public $currentBlock;
    public $showUnAssigned;
    public $serialized;
    public $globalpublics = Array ();
    public $prepared;
