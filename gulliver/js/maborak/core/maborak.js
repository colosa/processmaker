...
break;case"<selec":aObjects1=oCell1.getElementsByTagName("select");aObjects2=oCell2.getElementsByTagName("select");if(aObjects1&&aObjects2){selectCloneOption.call(aObjects1[0],aObjects2[0],"");aObjects1[0].value=aObjects2[0].value;aObjects1[0].className=aObjects2[0].className;}
